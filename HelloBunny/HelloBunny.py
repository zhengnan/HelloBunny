...
while running:
	...
	playerrot  = pygame.transform.rotate(player, 360 - angle*57.29)#1' = 360/2pie
...
if exitcode == 0:
	pygame.font.init()
	font = pygame.font.Font(None, 24)
	text = font.render("Accuracy:" + str(accuracy) + "%", 
		True, (255, 0, 0))
